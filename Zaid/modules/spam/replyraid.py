...
async def pornspam(xspam: Client, e: Message): 
    ...
    if int(e.chat.id) in GROUP:
         return await e.reply_text("**❖ sᴏʀʀʏ ᴛʜɪs ɢʀᴏᴜᴘ ᴘʀᴏᴛᴇᴄᴛ ʙʏ sᴀɴᴀᴛᴀɴɪ**")
    kkk = "**#Pornspam**"
    count = int(counts)
...
#              return #remove # to enable this
          if int(id) in VERIFIED_USERS:
                text = f"❖ sᴏʀʀʏ ! ᴛʜɪs ɪs ᴠᴇʀɪғɪᴇᴅ ᴜsᴇʀ..!!"
                await e.reply_text(text)
          elif int(id) in SUDO_USERS:
                text = f"❖ sᴏʀʀʏ ! ᴛʜɪs ɪs ᴀ sᴜᴅᴏ ᴜsᴇʀ..!!"
                await e.reply_text(text)
          else:
              fname = ok.first_name
          ...
          await e.reply_text("❖ ᴜsᴀɢᴇ : .raid count username")
